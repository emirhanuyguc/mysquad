...
class _MainScreenState extends State<MapScreen> {
  ...
  void getMarkers() async {
    final Uint8List userMarkerIcon =
        await getBytesFromAsset('assets/icons/marker.png', 75);

    final Uint8List selectedMarkerIcon =
        await getBytesFromAsset('assets/icons/marker_selected.png', 100);
  ...
  void initState() {
    Tools.markersList.add(MarkersModel(
        1,
        "Employee1",
        "En son yapılan görev hakkında açıklama",
        "36.752887",
        "3.042048",
        "https://firebasestorage.googleapis.com/v0/b/mysquad-1ab28.appspot.com/o/user_logo%2F20TeafzyqFZRfAgSaxCaB1TWASH2.jpg?alt=media&token=62be3e43-a5eb-4ef8-900b-5e7a2b80b1ea"));
    Tools.markersList.add(MarkersModel(
        1,
        "Employee2",
        "En son yapılan görev hakkında açıklama",
        "36.7850",
        "3.0608",
        "https://firebasestorage.googleapis.com/v0/b/mysquad-1ab28.appspot.com/o/user_logo%2FHjJNwuol2PVvVV1PN4itdp4zUPg1.jpg?alt=media&token=d8668b56-ae98-4bc9-a43f-f797399fc4ae"));
    Tools.markersList.add(MarkersModel(
        1,
        "Employee3",
        "En son yapılan görev hakkında açıklama",
        "36.7456",
        "3.0698",
        "https://firebasestorage.googleapis.com/v0/b/mysquad-1ab28.appspot.com/o/user_logo%2Femployee1%40gmail.com.jpg?alt=media&token=12845713-2766-45d1-a9f3-3b730aacd5f7"));
    getMarkers();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<int>(
        ...
        builder: (context, snapshot) {
          return Scaffold(
              appBar: AppBar(
                title: const Text('Ekibim Nerede ?'),
              ),
              drawer: AppDrawer(),
              body: Stack(
                children: <Widget>[
